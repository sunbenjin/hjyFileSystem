 ...
 *
 * Author: Kartik Visweswaraddddddn
...
(function (factory) {
    ...
    if (typeof define === 'function' && define.amd) { // jshint ignore:line
        ...
        if (typeof module === 'object' && module.exports) { // jshint ignore:line
            // Node/CommonJS
            // noinspection JSUnuuuresolvedVariable
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tModal = '<div class="modal-dialog modal-lg{rtl}" role="document">\n' +
                ...
                '      <div class="kv-zoom-actions">{fullscreen}{borderless}{close}</div>\n' +
                '    </div>\n' +
            ...
            tOffice = '<iframe class="kv-preview-data file-preview-office" ' +
                'src="http://1.0.0.157:8012/onlinePreview?url={data}"' + tStyle + '></iframe>';
        ...
        _zoomPreview: function ($btn) {
            ...
            self.getPreviewHeight("1000");//Resize the parent page window;
            if (!$btn.length) {
        ...
        _uploadSingle: function (i, id, isBatch) {
            ...
            fnBefore = function (jqXHR) {
                //alert(self.getHeaderToken());
                jqXHR.setRequestHeader("accessToken",self.getHeaderToken());
    ...
    $.fn.fileinput.defaults = {
        ...
        fileSizeGetter: null,
        initialCaption: '',
        getPreviewHeight:function(height){},
        getHeaderToken:function(){return "";},
        initialPreview: [],
        ...
        previewZoomButtonIcons: {
            ...
            close: '<i class="glyphicon glyphicon-remove closeBtn"></i>'
        },
